...
def poll_equipment():
    ...
    while True:
        ...
        data_df = pd.concat([data_df, pd.DataFrame([equipment_data])], ignore_index=True)
...
app.layout = html.Div([
    ...
    dcc.Interval(id="interval-component", interval=interval_time, n_intervals=0)  # Update every second
])
